...
) = model("ginjal.csv", "penyakit_ginjal_kronik.csv")
...
if option == "Home" or option == "":
    ...
    st.write("Website ini Untuk Mendeteksi Penyakit Ginjal Kronis")
    col1, col2 = st.columns(2)
    with col1:
        st.image("ginjal.jpeg", width=200)
    with col2:
        st.write(f"""
        Name : Azzahra Andini Putry \n
        NIM  : E13.2022.00201
        """)
